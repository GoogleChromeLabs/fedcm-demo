...
This demo is part of a pair. You will also need to run the corresponding **[RP Demo](../fedcm-demo-rp)** for the full sign-in flow to work.
...
git init fedcm-demo-idp-project
cd fedcm-demo-idp-project
...
1.  Create a new file in the current `fedcm/fedcm-demo-idp` file named `.env`.
